// aslp-nnetbin/aslp-nnet-forward-skip.cc
...
int main(int argc, char *argv[]) {
    ...
    try {
        const char *usage =
            ...
            "\n"
            "Usage:  aslp-nnet-forward-skip [options] <model-in> <feature-rspecifier> <feature-wspecifier>\n"
            "e.g.: \n"
            " aslp-nnet-forward-skip nnet ark:features.ark ark:mlpoutput.ark\n";
        ...
        for (; !feature_reader.Done(); feature_reader.Next()) {
            ...
            for (int skip_offset = 0; skip_offset < skip_width; skip_offset++) {
                int skip_len = (feats_transf.NumRows() - 1 - skip_offset) / skip_width + 1;
                ...
                // Reize nnet out
                if (nnet_out.NumRows() != feats_transf.NumRows() || 
