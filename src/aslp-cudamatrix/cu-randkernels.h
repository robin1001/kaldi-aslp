// aslp-cudamatrix/cu-randkernels.h
...
#ifndef ASLP_CUDAMATRIX_CU_RANDKERNELS_H_
#define ASLP_CUDAMATRIX_CU_RANDKERNELS_H_

#if HAVE_CUDA == 1

#include "base/kaldi-error.h"
#include "aslp-cudamatrix/cu-randkernels-ansi.h"
