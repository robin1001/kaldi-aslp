// aslp-bin/aslp-compile-questions-phone.cc
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    const char *usage =
        "Compile questions for phone cluster\n"
        "Usage:  aslp-compile-questions-phone [options] <topo> <questions-text-file> <questions-out>\n"
        "e.g.: \n"
        " aslp-compile-questions-phone questions.txt questions.qst\n";
    bool binary = true;
    int32 P = 1, N = 3;
