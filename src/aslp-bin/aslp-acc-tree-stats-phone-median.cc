// aslp-bin/aslp-acc-tree-stats-median.cc
...
int main(int argc, char *argv[]) {
  ...
  try {
    const char *usage =
        "Accumulate statistics using median stats for phonetic-context tree building.\n"
        "Usage:  aslp-acc-tree-stats-median [options] model-in features-rspecifier alignments-rspecifier [tree-accs-out]\n"
        "e.g.: \n"
        " aslp-acc-tree-stats-median 1.mdl scp:train.scp ark:1.ali 1.tacc\n";
