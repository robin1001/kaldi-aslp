...
if [ ! -z "$labels" ]; then
  ...
  labels_tr="ark:ali-to-phones --per-frame=true $alidir/final.mdl \\\"ark:gunzip -c $alidir/ali.*.gz |\\\" ark:- | aslp-kws-convert-phone-ali $phone_map_file ark:- ark:- | ali-to-post ark:- ark:- |"
  labels_cv="ark:ali-to-phones --per-frame=true $alidir_cv/final.mdl \\\"ark:gunzip -c $alidir_cv/ali.*.gz |\\\" ark:- | aslp-kws-convert-phone-ali $phone_map_file ark:- ark:- | ali-to-post ark:- ark:- |"
fi
