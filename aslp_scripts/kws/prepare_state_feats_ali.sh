...
if [ ! -z "$labels" ]; then
  ...
  labels_tr="ark:copy-int-vector \\\"ark:gunzip -c $alidir/ali.*.gz |\\\" ark:- | aslp-kws-convert-phone-ali $phone_map_file ark:- ark:- | ali-to-post ark:- ark:- |"
  labels_cv="ark:copy-int-vector \\\"ark:gunzip -c $alidir_cv/ali.*.gz |\\\" ark:- | aslp-kws-convert-phone-ali $phone_map_file ark:- ark:- | ali-to-post ark:- ark:- |"
fi
