...
dir=exp/kws_dnn_one_keyword_perturb_simulation_${train_reps}_5layers_256_state
...
if [ $stage -le 3 ]; then
    ...
    aslp-kws-gen-state-map data/lang/phones.txt $dir/hotword.lexicon $ali/final.mdl $ali/tree $dir/phone.map $dir/hotword.phone.int > $dir/hotword.lexicon.state
    utils/filter_scp.pl $dir/hotword.filler $dir/hotword.phone.int > $dir/hotword.filler.int
fi

if [ $stage -le 4 ]; then
    python aslp_scripts/kws/gen_text_fst.py $dir/hotword.lexicon.state $dir/hotword.text.openfst
...
if [ $stage -le 5 ]; then
    ...
    aslp_scripts/kws/prepare_state_feats_ali.sh \
