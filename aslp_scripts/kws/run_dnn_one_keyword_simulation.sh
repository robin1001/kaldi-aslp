...
train_reps=5
test_reps=10
ali=exp/tri3a_merge_simulation_${train_reps}_ali
train_merge_data=data/kws/train_kws_simulation_${train_reps}
test_merge_data=data/kws/test_kws_simulation_${test_reps}
feat_dir=fbank_simulation_${train_reps}
dir=exp/kws_dnn_one_keyword_simulation_${train_reps}_5layers_256
