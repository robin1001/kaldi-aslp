...
# data processing,
train_tool="aslp-nnet-train-simple-mpi"
cv_tool="aslp-nnet-train-simple"
train_tool_opts=

# nnet mpi sync peroid
sync_period=100
...
$cv_tool --cross-validate=true --randomize=false --verbose=$verbose $train_tool_opts \
...
for iter in $(seq -w $max_iters); do
  ...
  mpirun -np 2 -output-filename $log \
