...
skip=3
dir=exp/mono_cnn_2dnn_2blstm_eesen_ctc
ali=${gmmdir}
num_cv_utt=500
...
<AffineTransform> <InputDim> 1024 <OutputDim> 1024 <BiasMean> -2.000000 <BiasRange> 4.000000 <ParamStddev> 0.1 <ClipGradient> 5.000000
<BatchNormalization> <InputDim> 1024 <OutputDim> 1024
<Sigmoid> <InputDim> 1024 <OutputDim> 1024
<AffineTransform> <InputDim> 1024 <OutputDim> 512 <BiasMean> -2.000000 <BiasRange> 4.000000 <ParamStddev> 0.1 <ClipGradient> 5.000000
...
<BLstmProjectedStreams> <InputDim> 512 <OutputDim> 512 <CellDim> 1024 <ParamScale> 0.010000 <ClipGradient> 5.000000
<BatchNormalization> <InputDim> 512 <OutputDim> 512
<AffineTransform> <InputDim> 512 <OutputDim> $num_tgt <BiasMean> 0.0 <BiasRange> 0.0 <ParamStddev> 0.040000 <ClipGradient> 5.000000
...
if [ $stage -le 3 ]; then
    ...
    aslp_scripts/aslp_nnet/train_scheduler_ctc.sh --train-tool "aslp-nnet-train-ctc-streams" \
        --learn-rate 1e-5 \
        --momentum 0.9 \
        --train-tool-opts "--num-stream=10 --report-step=1000 --report-period=40 --skip-width=${skip} --drop-len=1500" \
