...
skip=3
dir=exp/mono_cnn_2dnn_2lstm_ctc
ali=${gmmdir}
num_cv_utt=500
...
if [ $stage -le 3 ]; then
    ...
    #cp nnet/train.nnet_iter17_learnrate1.5625e-07_cv0.3305 $dir/nnet/train.nnet.init 
    #aslp-nnet-init --seed=1 $dir/nnet.proto $nnet_init
